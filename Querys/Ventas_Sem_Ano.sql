...
FROM (
    ...
    SELECT
        ...
        VMT.vmt_marca AS marca, ST.fecha, SEM.n_sem, SEM.ano,
    ...
    SELECT
        ...
        VMT.vmt_marca AS marca, VT.fecha, SEM.n_sem, SEM.ano,
    ...
    INNER JOIN Valid_Marca_Tipo VMT ON VMT.vmt_tipo = M.tipo 
        ...
        AND VMT.vmt_marca = COALESCE(
            ...
            (SELECT new_marca FROM dbo.marca WHERE marca_bd = VT.marca LIMIT 1),
            EC.marca
        )
